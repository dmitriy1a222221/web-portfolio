...
import { getDataPortfolio } from '../../actions/authActions';



class ReviewPortfolio extends Component {
    constructor(props) {
        super(props);

        this.onDeploymentBlock = this.onDeploymentBlock.bind(this)
    }
    ...
    onDeploymentBlock(e) {
        e.target.classList.toggle('_select')
    }
                        ...
                        <ul className="collapsible">
                            <li>
                                <h3
                                    ...
                                    onClick={(e) => this.onDeploymentBlock(e)}
                                >
